"""
run_nqps_rd_ph3d_r1_branch.py — NQPS Pass 3d Requirement Derivation, Row 1.

Creates a disposable test branch from snap_ph03_3c_AllProjects, applies
schema migrations, runs Requirement Derivation for NQPS_E2E Row 1, exports
a JSON ledger, and leaves the branch alive for analysis.

Delete when done:
  python sysengage/scripts/branch_manager.py delete_test_branch \\
    --branch test_ALL_ph03_3c_R1_Ph3d_RD_NQPS_R1
"""
...
TEST_BRANCH_NAME = "test_ALL_ph03_3c_R1_Ph3d_RD_NQPS_R1"
...
# ── Step 7: Summary ────────────────────────────────────────────────────────────
print("=" * 60, flush=True)
print("[orchestrator] Pass 3d Row 1 completed successfully.", flush=True)
