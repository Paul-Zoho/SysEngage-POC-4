...
Filename: SysEngage_Row_4_Mechanism_CCI_Construction_v0_14.md

Version: 0.14 (column_interrogatives.py — named-instance instruction for Where column at Rows 4 and 5)

Date: 16 May 2026

**Purpose.** Implementation specification for the CellContentItem Construction mechanism (Pass 3b). v0.14 adds Stage 3a-pre — a DM named-item enumeration pre-processor that splits qualifying Signals into virtual sub-signals before the Stage 3a AI call. This fixes named-instance loss through the Signal → CCI → Requirement elaboration chain. Also adds `named_entity_vocabulary.py` to the module structure and `enumeration_splits` to the AnalysisPass outputs.
...
| --- | --- |
| **Row 3 Mechanism Spec reference** | SysEngage_Row_3_Mechanism_CCI_Construction_v0_13.md — all sections |
...
| --- | --- | --- |
| **Row 3 Mechanism Spec v0.13** | All sections | Architectural spec including Stage 3a-pre enumeration pre-processor and §9.8 edge cases |
...
Companion artefact: SysEngage_Row_3_Mechanism_CCI_Construction_v0_13.md
