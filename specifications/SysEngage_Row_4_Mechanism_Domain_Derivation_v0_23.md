...
Filename: SysEngage_Row_4_Mechanism_Domain_Derivation_v0_23.md

Version: 0.23 (ROW_GUIDANCE["3"]/["4"]/["5"] — "and"/"&" prohibition and single-objective test added; Row 3 "computation/reporting" vocabulary note added. All rows 1–5 now carry structured guidance blocks. Supersedes v0.22.)

Date: 26 May 2026

**Purpose.** Implementation specification for the Domain Derivation mechanism (Pass 3c). v0.23 extends the "and"/"&" prohibition and single-objective test from ROW_GUIDANCE["2"] to all remaining content rows (3, 4, 5). Production evidence (PMT Run 9 Row 3 D014 "Earnings Computation and Reporting Model") confirmed the need. All rows 1–5 now carry fully consistent structured guidance. Supersedes v0.22.
...
| **Tracker v0.49** | F43, F53, F58 | F43: Action-Required (pass catalogue mode label). F53: Action-Required (Row 3 Understanding §E.12.1 amendment). F58: v0.12 execution_warnings/no_cci_input fixes (Resolved). |
...
- This spec (Row 4 Mechanism Spec — Domain Derivation v0.23) — implementation authority (all detail including DDL in §5.1)
...
End of SysEngage Row 4 Mechanism: Domain Derivation v0.23.

Changes from v0.22 (ROW_GUIDANCE["3"]/["4"]/["5"] — "and"/"&" prohibition extended):
- **§5.4 ROW_GUIDANCE["3"]:** "and"/"&" prohibition added to qualification questions, vocabulary signals, and prohibition rules. Single-objective test added to qualification questions. Row 3 vocabulary note added distinguishing "computation/reporting" (Row 5) from "derivation logic/decision model" (Row 3). Evidence: PMT Run 9 D014 "Earnings Computation and Reporting Model".
- **§5.4 ROW_GUIDANCE["4"]:** "and"/"&" prohibition added to qualification questions, vocabulary signals, and prohibition rules.
- **§5.4 ROW_GUIDANCE["5"]:** "and"/"&" prohibition added to qualification questions, vocabulary signals, and prohibition rules.
- **§5.4 prompt template note:** Updated to reflect that all rows 1–5 now carry structured multi-paragraph guidance blocks. Row 6 retains short phrase.

Changes from v0.21: CHK-3c-08; ROW_GUIDANCE["2"] strengthened.
Changes from v0.20: ADVC-3c-01 inverted-range guard.
Changes from v0.19: Rows 3–5 prompt guidance (initial structured blocks).
...
- SysEngage_Issues_Tracker_v0_49.md — finding disposition
