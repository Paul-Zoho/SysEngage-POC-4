...
Filename: SysEngage_Row_4_Mechanism_CCI_Construction_v0_13.md

Version: 0.13 (column_interrogatives.py — named-instance instruction for Where column at Rows 4 and 5)

Date: 16 May 2026

**Purpose.** Implementation specification for the CellContentItem Construction mechanism (Pass 3b). v0.13 changes the Stage 4b named-instance prompt variant from a determination request to a preservation directive: groups containing `stage4a_routed=True` candidates receive a directive to return all members as Distinct — the AI's latitude to merge is removed for these cases.
...
| --- | --- |
| **Row 3 Mechanism Spec reference** | SysEngage_Row_3_Mechanism_CCI_Construction_v0_12.md — all sections |
...
| --- | --- | --- |
| **Row 3 Mechanism Spec v0.12** | All sections | Architectural spec including preservation directive for Stage 4b named-instance groups |
...
Companion artefact: SysEngage_Row_3_Mechanism_CCI_Construction_v0_12.md
