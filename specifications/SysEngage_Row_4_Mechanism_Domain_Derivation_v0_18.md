...
Filename: SysEngage_Row_4_Mechanism_Domain_Derivation_v0_18.md

Version: 0.18 (CHK-3c-07 single-CCI domain absorption added; new prompt/schema; mechanism_data fields; VER-3c-13; PLB-3c-06 reframed. Stale version references corrected. Supersedes v0.17.)

Date: 26 May 2026

**Purpose.** Implementation specification for the Domain Derivation mechanism (Pass 3c). v0.18 promotes the single-artefact domain prohibition from PLB-3c-06 (post-run advisory) to CHK-3c-07 (automated Stage 3 repair). Supersedes v0.17.
...
| **Tracker v0.44** | F43, F53, F58 | F43: Action-Required (pass catalogue mode label). F53: Action-Required (Row 3 Understanding §E.12.1 amendment). F58: v0.12 execution_warnings/no_cci_input fixes (Resolved). |
...
- This spec (Row 4 Mechanism Spec — Domain Derivation v0.18) — implementation authority (all detail including DDL in §5.1)
...
End of SysEngage Row 4 Mechanism: Domain Derivation v0.18.
...
- SysEngage_Row_4_Understanding_v0_23.md — implementation framework
