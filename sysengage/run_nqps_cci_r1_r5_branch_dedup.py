"""
run_nqps_cci_r1_r5_branch_dedup.py — Branch-isolated CCI Construction, NQPS Rows 1-5, dedup ON.

Workflow:
  1. Clone a fresh test branch from snap_NQPS_ph03_3a_R5 (scenario Ph3b_Dedup_On)
...
The runner subprocess (run_nqps_cci_r1_r5_dedup.py) is invoked with NEON_DATABASE_URL
set to the test branch connection string — the parent environment is never mutated.

Invocation (from workspace root):
    python -u sysengage/run_nqps_cci_r1_r5_branch_dedup.py
"""
...
SNAP_NAME = "snap_NQPS_ph03_3a_R5"
SCENARIO = "Ph3b_Dedup_On"
BRANCH_NAME = f"test_NQPS_ph03_3a_R5_{SCENARIO}"
...
def main() -> None:
    banner("NQPS Rows 1-5  •  dedup ON  •  branch-isolated")
