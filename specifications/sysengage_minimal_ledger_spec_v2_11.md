...
- Each entry in `source_refs` MUST reference an existing `Source.source_id` or Requirement.requirent_id.
...
- `sysengage_ledger_version` MUST equal the specification version of this ledger model (e.g., "2.11").
...

{
   ...
   "title":"SysEngage Ledger Instance (v2.11) — Canonical Serialization",
...
"Stakeholder",
         ...
         "description":"Permitted element types (ledger spec v2.11)."
