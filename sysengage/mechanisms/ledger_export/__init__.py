...
a canonical JSON ledger conforming to spec v2.15.
...
def run_ledger_export(
    ...
    Reads all entities from the DB and builds the canonical JSON structure.
    Does NOT write to disk — the caller decides where to persist the output.
