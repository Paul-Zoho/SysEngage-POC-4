"""
run_nqps_rd_ph3d_allrows_branch.py — NQPS Pass 3d Requirement Derivation, Rows 1–5.

Creates one disposable test branch from snap_ph03_3c_AllProjects, applies
schema migrations, runs Requirement Derivation for NQPS_E2E Rows 1–5 in
sequence, then exports a single project-wide JSON ledger.

Note: NQPS Row 4 has zero CCIs — the mechanism takes the no_cci_input path
(CompletedWithWarnings, register preserved, Stage 2 not invoked). This is
expected and correct.

Delete when done:
  python sysengage/scripts/branch_manager.py delete_test_branch \\
    --branch test_ALL_ph03_3c_Ph3d_RD_NQPS_R1toR5
"""
...
TEST_BRANCH_NAME = "test_ALL_ph03_3c_Ph3d_RD_NQPS_R1toR5"

PROJECT_ID = "NQPS_E2E"
PROJECT_CODE = "NQPS"
PRACTITIONER_ID = "SH001"
ROWS = [1, 2, 3, 4, 5]  # Row 4: zero CCIs → no_cci_input path (expected)
