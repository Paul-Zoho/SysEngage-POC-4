...
Filename: SysEngage_Row_4_Mechanism_CCI_Construction_v0_12.md

Version: 0.12 (column_interrogatives.py — named-instance instruction for Where column at Rows 4 and 5)

Date: 16 May 2026

**Purpose.** Implementation specification for the CellContentItem Construction mechanism (Pass 3b). v0.12 adds named-instance instruction to `prompts/column_interrogatives.py` for the Where column at Rows 4 and 5. The instruction is delivered at Stage 3a derivation time, preventing the AI from consolidating named deployment targets (iOS, Android, Windows etc.) into aggregate CCIs before Stage 4b sees them.
...
| --- | --- |
| **Row 3 Mechanism Spec reference** | SysEngage_Row_3_Mechanism_CCI_Construction_v0_11.md — all sections |
...
| --- | --- | --- |
| **Row 3 Mechanism Spec v0.11** | All sections | Architectural spec including §5.2 named-instance instruction for Where column at Rows 4 and 5 |
...
Companion artefact: SysEngage_Row_3_Mechanism_CCI_Construction_v0_11.md
